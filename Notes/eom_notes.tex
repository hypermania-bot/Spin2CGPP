...
The remaining unsolved step is simplification rather than derivation. The final equations are currently too large to compare term-by-term to the paper's closed-form coefficient basis $(K_\varphi,M_\varphi,K_B,M_B,L_2,L_1,L_0)$ without further symbolic reduction.
...
The largest remaining gap is not the covariant-to-scalar derivation itself, but the simplification of the final minimally coupled scalar equations into the compact coefficient basis displayed in eq.~(3.18) of the paper. The project now reconstructs the intermediate constraint elimination from the covariant quadratic action for the minimally coupled scalar sector, but it does not yet rewrite the final two-field equations into the closed forms $(K_\varphi,M_\varphi,K_B,M_B,L_2,L_1,L_0)$. The nonminimal scalar-sector derivation from the covariant action also remains to be automated at the same level.
