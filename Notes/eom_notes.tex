...
The minimally coupled scalar-sector derivation is now automated from the covariant quadratic action through the paper's reduced-action coefficient basis. The remaining limitation is separate: the nonminimal scalar-sector derivation from the covariant action has not yet been automated at the same level.
